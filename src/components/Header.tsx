...
export default function Header({ onAddExpense, onOpenExportStudio }: HeaderProps) {
  return (
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-transparent bg-gradient-to-r from-indigo-600 to-violet-600 px-3 py-2 text-sm font-medium text-white shadow-sm transition hover:opacity-90 sm:px-3.5"
          >
